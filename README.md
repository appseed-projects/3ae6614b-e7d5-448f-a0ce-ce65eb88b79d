# [SB Admin](https://appseed.us/generator/sb-admin/) Flask

Open-source **Flask Dashboard** generated by `AppSeed` op top of an iconic design. For newcomers, **[SB Admin](https://appseed.us/generator/sb-admin/)** is one of the best open-source admin dashboard & control panel theme. Built on top of Bootstrap, `SB Admin` provides a range of responsive, reusable, and commonly used components. 
...
- Timestamp: `2022-06-23 23:45`
- Build ID: `3ae6614b-e7d5-448f-a0ce-ce65eb88b79d`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/3ae6614b-e7d5-448f-a0ce-ce65eb88b79d.git
$ cd 3ae6614b-e7d5-448f-a0ce-ce65eb88b79d
```
...
---
[SB Admin](https://appseed.us/generator/sb-admin/) Flask - Open-source starter generated by **[AppSeed Generator](https://appseed.us/generator/)**.
